...
data are revised / updated, we allow descriptions to last for multiple version of 
a time series. 
...
Dataset level meta information can currently only be assigned when the dataset
