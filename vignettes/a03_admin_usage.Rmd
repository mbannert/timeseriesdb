...
[db_access_list_levels()](../reference/db_access_list_levels.html) lists all access levels available for a schema. 
...
set post creation as well using [db_access_set_default()](../reference/db_access_set_default.html). To delete levels, 
run [db_access_delete_level()](../reference/db_access_delete_level.html).
...
[db_ts_change_access_dataset()](../reference/db_ts_change_access_dataset.html).
