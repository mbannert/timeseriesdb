...
test_with_fresh_db(con_admin, "db_collection_add add new collection & keys", {
  ...
  collections_result <- dbGetQuery(con_admin, "SELECT * FROM timeseries.collections
  ...
  collect_catalog_result <- dbGetQuery(con_admin, "SELECT timeseries.collections.id, ts_key FROM timeseries.collect_catalog
                                       JOIN timeseries.collections
                                       ON timeseries.collect_catalog.id = timeseries.collections.id
                                       AND name = 'tests new'")
...
test_with_fresh_db(con_admin, "db_collection_remove state", {
  ...
  result <- dbGetQuery(con_admin, "SELECT ts_key FROM timeseries.collect_catalog
                             JOIN timeseries.collections
                             ON timeseries.collect_catalog.id = timeseries.collections.id
                             AND name = 'tests first'")
  ...
  result_collections <- dbGetQuery(con_admin, "SELECT 1 FROM timeseries.collections
...
test_with_fresh_db(con_admin, "db_collection_delete db state", {
  ...
  result_collections <- dbGetQuery(con_admin, "SELECT * FROM timeseries.collections
                                         WHERE name = 'tests first'")
  expect_equal(nrow(result_collections), 0)

  result_collect_catalog <- dbGetQuery(con_admin, sprintf("SELECT * FROM timeseries.collect_catalog WHERE id = '%s'", out$id))
...
test_with_fresh_db(con_admin, "db_collection_delete with missing user+collection does nothing", {
  ...
  result_collect_catalog <- dbGetQuery(con_admin, "SELECT * FROM timeseries.collect_catalog")
